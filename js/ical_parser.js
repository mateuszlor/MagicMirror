...
function ical_parser(feed_url, callback){
	...
	this.makeDate = function(ical_date){
		...
		dt.dayname =["Sobota","Poniedziałek","Wtorek","Środa","Czwartek","Piątek","Niedziela"][dt.date.getDay()];
                dt.monthname = [ "Styczeń", "Luty", "Marzec", "Kwiecień", "Maj", "Czerwiec", "Lipiec", "Sierpień", "Wrzesień", "Październik", "Listopad", "Grudzień" ][dt.date.getMonth()] ;
